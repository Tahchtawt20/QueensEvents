...
<body data-spy="scroll" data-target="#navbar" class="static-layout">
    ...
    <div class="boxed-page" style="height:90vh">
        <nav id="navbar-header" class="navbar navbar-expand-lg">
            <div class="container">
                ...
                <div class="collapse navbar-collapse justify-content-between" id="navbarSupportedContent">
                    <ul class="navbar-nav d-flex justify-content-between">
                        ...
                        <div class="d-flex flex-lg-row flex-column">
                            <li class="nav-item active">
                                <a class="nav-link" href={{ route('welcome') }}>{{ __('messages.home') }}<span
                    ...
                    <a class="navbar-brand navbar-brand-center d-flex align-items-center only-desktop"
                        href="{{ route('welcome') }}">
                        <img src="{{ asset('Queens.png') }}" alt="">
                    </a>
                    <ul class="navbar-nav d-flex justify-content-between">
                        <div class="d-flex flex-lg-row flex-column">
                                ...
                                <li class="nav-item dropdown">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                                        <a href="{{ route('reservation') }}"
                                            class="dropdown-item">{{ __('messages.reservation') }}</a>
                                        <a href="{{ route('reservation') }}"
                                            class="dropdown-item">{{ __('messages.myevents') }}</a>
                                        <a href="{{ route('reservation') }}"
                                            class="dropdown-item">{{ __('messages.account') }}</a>
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                    <a class="dropdown-item" href="{{ route('lang', ['lang' => 'en']) }}"><svg
                                    ...
                                    <a class="dropdown-item" href="{{ route('lang', ['lang' => 'fr']) }}"><svg
                                            xmlns="http://www.w3.org/2000/svg"
                                            xmlns:xlink="http://www.w3.org/1999/xlink" width="40"
                                            zoomAndPan="magnify" viewBox="0 0 30 30.000001" height="40"
                                            preserveAspectRatio="xMidYMid meet" version="1.0">
                                            ...
                                            <g clip-path="url(#id2)">
                                                <path fill="rgb(0%, 14.118958%, 58.428955%)"
