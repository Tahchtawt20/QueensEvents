            ...
            <div class="section-content">
                ...
                <div class="row mt-5">
                    <div class="col-lg-5 col-md-6 align-self-center py-5">
                        ...
                        <div class="dishes-text">
                            <h3><span>{{ __('messages.white') }}</span></h3>
                        ...
                        <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
                            <div class="carousel-inner my-5">
                                <div class="carousel-item active">
                                    <img class="d-block w-100" src="{{ asset('white1.png') }}" alt="First slide">
                                </div>
                                <div class="carousel-item">
                                    <img class="d-block w-100" src="{{ asset('white2.png') }}" alt="Third slide">
                                </div>
                                <div class="carousel-item">
                                    <img class="d-block w-100" src="{{ asset('white3.png') }}" alt="Fourth slide">
                                </div>
                            </div>
                ...
                <div class="row mt-5">
                    <div class="col-lg-5 col-md-6 align-self-center order-2 order-md-1 mt-4 mt-md-0">
                        <div id="carouselControls" class="carousel slide" data-ride="carousel">
                            <div class="carousel-inner">
                                <div class="carousel-item active">
                                    <img class="d-block w-100" src="{{ asset('bluepink1.jpg') }}" alt="First dish">
                                </div>
                                <div class="carousel-item">
                                    <img class="d-block w-100" src="{{ asset('bluepink2.jpg') }}" alt="Second dish">
                                </div>
                                <div class="carousel-item">
                                    <img class="d-block w-100" src="{{ asset('bluepink3.jpg') }}" alt="Third dish">
                                </div>
                    ...
                    <div class="col-lg-5 offset-lg-2 col-md-6 align-self-center order-1 order-md-2 py-5">
                        ...
                        <div class="dishes-text">
                            <h3><span>{{ __('messages.bluepink') }}</span></h3>
                            ...
                            <a href="#" class="btn-primary mt-3">{{ __('messages.bookNow') }} <span><i
                ...
                <div class="row mt-5">
                    <div class="col-lg-5 col-md-6 align-self-center py-5">
                        ...
                        <div class="dishes-text">
                            <h3><span>{{ __('messages.starry') }}</span></h3>
                            ...
                            <a href="#" class="btn-primary mt-3">{{ __('messages.bookNow') }}</a>
                        </div>
                    </div>
                    <div class="col-lg-5 offset-lg-2 col-md-6 align-self-center mt-4 mt-md-0">
                        <div id="carouselJuiceControls" class="carousel slide" data-ride="carousel">
                            <div class="carousel-inner">
                                <div class="carousel-item active">
                                    <img class="d-block w-100" src="{{ asset('starry1.jpeg') }}" alt="First slide">
                                </div>
                                <div class="carousel-item">
                                    <img class="d-block w-100" src="{{ asset('starry2.jpeg') }}" alt="Second slide">
                                </div>
                                <div class="carousel-item">
                                    <img class="d-block w-100" src="{{ asset('starry3.jpeg') }}" alt="Third slide">
                                </div>
